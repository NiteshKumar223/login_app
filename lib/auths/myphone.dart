      ...
      child: SingleChildScrollView(
        child: Column(children: <Widget>[
          ...
          const SizedBox(
              ...
              width: 250,
              child: Image(
                image: AssetImage("assets/images/entmobile.png"),
              )),
          ...
          const SizedBox(height: 15.0),
          const Text(
            "Enter your phone number to register on this app for using every services provided by us",
            style: TextStyle(
              fontSize: 14.0,
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Padding(
                  padding:
                      const EdgeInsets.only(right: 5.0, top: 5.0, bottom: 5.0),
